...
## 递归函数调用
![](IMG-20251210185524090.png)
![](IMG-20251210185524118.png)
...
## 写PC的方式
- PC相对寻址：条件分支语句，[立即数字段的offset和PC相加得到新PC值](MIPS_Assembly#条件分支.md)
![](IMG-20251210185524250.png)
- 伪直接寻址：[J类型指令](MIPS_Assembly#J类型.md)

# 内存映射
![](IMG-20251210185524276.png)

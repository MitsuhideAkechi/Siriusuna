# `QFile`
![](IMG-20251210185544212.png)

Example:
![](IMG-20251210185544335.png)
别忘了 close

![](IMG-20251210185544357.png)

# `QTextStream`
![](IMG-20251210185544380.png)
```cpp
in.setEncoding(QStringConverter::Utf8); // Qt6
```

![](IMG-20251210185544404.png)

# `QFileDialog`
![](IMG-20251210185544526.png)
```cpp
fileName = QFileDialog::getOpenFileName(this,
    tr("Open Image"), "/home/jana", tr("Image Files (*.png *.jpg *.bmp)"));
```
分步自定义与打开：
![](IMG-20251210185544659.png)
```cpp
// 1. 创建一个文件对话框对象
...
# 文件编码
![](IMG-20251210185544808.png)
![](IMG-20251210185544833.png)
![](IMG-20251210185544859.png)
![](IMG-20251210185544997.png)

# 光标位置
![](IMG-20251210185545025.png)

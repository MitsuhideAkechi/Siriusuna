...
![](IMG-20251211101603868.png)

![](IMG-20251211101603929.png)
...
## Drop
![](IMG-20251211101603986.png)

# Modifying Tables
## Insert
![](IMG-20251211101604053.png)
...
2. methods:
	1. `execute(<SQL statement>)`
		...
		- `"SELECT ..."` will return a cursor object which has a method called `fetchall` which will fetch the contents of the result table as [a list of](CS61A/Python/List.md)[tuples](Tuple.md).
		- Take one statement.
	2. `executescript()`

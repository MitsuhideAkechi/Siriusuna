...
# Basic Rules
1. Java is an [OOP](Object-Oriented_Programming(OOP).md) program language.All code in Java must be part of a class.
...
6. Java variables must have a specific [type](公开课/CS61B/Types.md).

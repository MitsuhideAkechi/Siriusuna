...
![](IMG-20251213194503988.png)
![](IMG-20251213194504004.png)
### 模板
#### Moore
![](IMG-20251213194504056.png)
### Mealy
![](IMG-20251213194504110.png)

# Verilog数据类型
![](IMG-20251213194504124.png)
![](IMG-20251213194504200.png)
Verliog主要用两种类型：`reg`和`wire`  
与SystemVerilog有诸多不同
![](IMG-20251213194504275.png)
> `reg`不一定和寄存器有关系
...
![](IMG-20251213194504344.png)
关键字：`initial`，用于初始化时运行一次块中指令。***不可综合。***

## 自检测试程序
可以自动检查是否符合输出向量
![](IMG-20251213194504400.png)
> `==` and `===`
![](IMG-20251213194504414.png)

可以把测试向量卸载单独文件中，测试程序读取、输入、判断输出。
![](IMG-20251213194504468.png)

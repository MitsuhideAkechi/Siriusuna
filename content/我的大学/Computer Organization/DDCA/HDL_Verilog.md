...
![](IMG-20251213231414318.png)
![](IMG-20251213231414378.png)
### 模板
#### Moore
![](IMG-20251213231414433.png)
### Mealy
![](IMG-20251213231414497.png)

# Verilog数据类型
![](IMG-20251213231414565.png)
![](IMG-20251213231414590.png)
Verliog主要用两种类型：`reg`和`wire`  
与SystemVerilog有诸多不同
![](IMG-20251213231414621.png)
> `reg`不一定和寄存器有关系
...
![](IMG-20251213231414673.png)
关键字：`initial`，用于初始化时运行一次块中指令。***不可综合。***

## 自检测试程序
可以自动检查是否符合输出向量
![](IMG-20251213231414708.png)
> `==` and `===`
![](IMG-20251213231414738.png)

可以把测试向量卸载单独文件中，测试程序读取、输入、判断输出。
![](IMG-20251213231414767.png)
